...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		PlatkmSecurity platkmSecurity = (PlatkmSecurity) ObjectContainer.instance().geApptScopeObjByInterface(PlatkmSecurity.class);
	...
	private boolean isPublicApiCall(String uri) { 
		return ObjectContainer.instance().getPropertyValue("org.platkmframework.server.public.paths", "").contains(uri);
	} 

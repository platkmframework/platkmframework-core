...
public class ExceptionFilter implements Filter
{
	...
	private void processException(HttpServletResponse resp, CustomServletException e) throws ServletException {
		...
		if(ObjectContainer.instance().containsException(e.getCause())){
			...
			sendErrorInfo(resp, HttpStatus.INTERNAL_SERVER_ERROR_500, "No se pudo realizar el proceso, int�ntelo m�s tarde");
		}  
	}	
	
	private void sendErrorInfo(HttpServletResponse resp, int status, String msg) throws CustomServletException { 
